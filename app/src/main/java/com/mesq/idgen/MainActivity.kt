...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        botaoPrincipal.setOnClickListener {
            ...
            val alg1: Int =
                (1..9).random()        // gera os  9 primeiros dígitos do CPF de forma "aleatória"
            ...
            val t3 =
                alg3.times(8)              // multiplicar os 9 primeiros dígitos por 10,9,8,...,2
            val t4 = alg4.times(7)
            val t5 = alg5.times(6)
            val t6 = alg6.times(5)
            val t7 = alg7.times(4)
            ...
            val z3 =
                alg4.times(8)       // multiplicar os 9 dígitos a partir do segundo pela sequência
            val z4 =
                alg5.times(7)       // 10,9,8,...,2, tendo d1, calculado na primeira parte, como
